    ...
    def get_profitability_report(self):
        request = """
         ...
         select 
            ...
            ((delivery_unit_price*delivered_qty-return_unit_price*return_qty)-(delivery_cost*delivered_qty-return_cost*return_qty))/(delivery_unit_price) as profitability        
            from sales
            );
        """ % (self._table)        
        return request
